package com.ajfr.currency.converter.aop;
...
public class CurrencyConverterAspect {
    ...
    @Around(value = "execution(* com.ajfr.currency.converter.controller.CurrencyConverterRestController.*(..))")
    ...
    @Around(value = "execution(* com.ajfr.currency.converter.exception.handler.CurrencyConverterExceptionHandler.*(..))")
